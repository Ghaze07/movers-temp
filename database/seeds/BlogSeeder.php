    ...
    public function run()
    {
        ...
        $blog2 = [
            ...
            'content' => '
                ...
                <p>پاکستان میں یہ تصور عام ہے کہ مچھلی نہائیت گرم یا طاقتور (مقوی) شے ہے۔ لہذا اسکا استعمال صرف سردی کو دور کرنے کے لیئے کرنا چاہئے جو کہ سراسر غلط اور بے بنیاد مفرضہ ہے۔ اس کے علاوہ ہم کھانے میں سہولت پسندی کا شکار ہیں۔ مچھلی کے مقابلے میں مرغی کا گوشت سارا سال ملتا ہے اور کھانے میں بھی کوئی دقت پیش نہی آتی۔ بچے، بوڑھے یکساں طور پر باآسانی مرغی کا گوشت کھا سکتے ہیں جکہ مچھلی کے گوشت میں کانٹا ہونے کے سبب کھانے میں کافی محنت درکار رہتی ہے۔ </p>
                ...
                <p>ہم پنگاسیس مچھلی پال رہے ہیں اور غذائی اعتبار سے اس مچھلی کے ۱۰۰ گرام گوشت سے آپکو ۹۲ کیلوریز، ۱۵ گرام پروٹین، ۳۔۵ گرام چربی اور ۸۰ گرام کولیسٹرول حاصل ہوتا ہے۔</p>
